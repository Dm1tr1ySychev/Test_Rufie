...
txt_res1 = "Низкая. Срочно обратитесь к врачу!".upper()
txt_res2 = "Ниже среднего. Рекомендуем обратитесь к врачу!".upper()
txt_res3 = "Средняя. Возможно, стоит дополнительно обследоваться у врача.".upper()
